...
document.getElementById("taskForm").addEventListener(
    "submit", async function(event) {
        ...
        try {
            const response = await fetch('https://todo-app-437107.et.r.appspot.com/task', {
                method: 'POST',
                headers: {
...
function updateTask(taskId, isChecked, taskName) {
    ...
    fetch('https://todo-app-437107.et.r.appspot.com/task', {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json'
        },
...
async function loadTasks(userId) {
    try {
        const response = await fetch(`https://todo-app-437107.et.r.appspot.com/tasks/${userId}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
            }
